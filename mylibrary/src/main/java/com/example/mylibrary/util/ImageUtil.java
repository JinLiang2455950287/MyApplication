...
/**
 * Description:
 * author: zhangsan on 16/8/20 下午3:57.
 */
...
//                        EventBus.getDefault().post(new Event<>(C.EventKey.CLEAR_FINISH, C.EventKey.CLEAR_FINISH));
//                    }
//                }).start();
//            } else {
//                Glide.get(App.getInstance()).clearDiskCache();
...
//        clearImageDiskCache();
////        deleteFolderFile(Glide.getPhotoCacheDir(App.getInstance().getApplicationContext()).getPath(), true);
//    }
